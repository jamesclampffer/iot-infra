...
from mock_component_base import *
...
class SystemComponent(BaseMockComponent):
    ...
    def __init__(self, dev):
        ...
        self.config = {
            ...
            "debug": {"mqtt": None, "websocket": None, "udp": None},
            "cfg_rev": None,
        }
        ...
        self.system_state = {
            ...
            "webhook_rev": 0,
            "btrelay_rev": 0,
            "available_updates": {"stable": {"version": "0.10.2"}},
        }
...
class SwitchComponent(BaseMockComponent):
    ...
    def set(self, args: dict):
        ...
        if on:
            ...
            self.output = SwitchComponent.OutputValue.OFF
        return {"was_on": prior == SwitchComponent.OutputValue.ON}
